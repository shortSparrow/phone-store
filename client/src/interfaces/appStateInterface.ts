...
import {
  accessoriesCardInterface,
  accessoriesListStateType,
} from "./accessoriesStateInterface";
import { phoneCardInterface, phoneListStateType } from "./phonesInterfaces";
import {
  tabletCardInterface,
  tabletListStateType,
} from "./tabletStateInterface";
...
export type AppStateActionTypes =
  | setDeviceScreenInterface
  | setDevicesCountInterface
  | phoneListLoadingInterface
  | phoneListSuccessInterface
  | phoneListFailInterface
  | phoneListState
  | requestLoading
  | requestFailed
  | setFavoriteDevices
