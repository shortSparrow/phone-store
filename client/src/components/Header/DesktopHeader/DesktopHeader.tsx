  ...
  return (
    <div className="header-navigation__wrapper">
      <div className="header-navigation__item">
        <div className="header-nav__logo-wrapper" onClick={() => navigate("/")}>
          <img
            src="icons/logo.png"
          ...
          <ul className="header-nav__item-wrapper">
            <li
              className={`header-nav__item ${
                location.pathname === "/" ? "header-nav__item--active" : ""
              }`}
              onClick={() => navigate("/")}
            >
            ...
            >
              <Link to="/phones" className="header-nav__link">
                phones
              </Link>
            </li>
            ...
            >
              <Link to="/tablets" className="header-nav__link">
                tablet
              </Link>
            </li>
            ...
            >
              <Link to="/accessories" className="header-nav__link">
                accessories
              </Link>
            </li>
          </ul>
      ...
      <div className="header-navigation__item">
        <div
          className={`header-navigation__icon-wrapper ${
            location.pathname === "/favorites"
              ? "header-navigation__icon-wrapper--active"
              : ""
          }`}
