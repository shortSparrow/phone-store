  ...
  return (
    <div className="header-navigation-burger__wrapper">
      <div className="header-navigation-burger__line">
        <div
          className="header-nav-burger__logo-wrapper"
          onClick={() => navigate("/")}
        >
          <img
            src="icons/logo.png"
        ...
        {props.children && deviceScreen.value >= 500 ? (
          <div
            className="header-search-field--wrapper"
        ...
        <div className="header-nav-burger__menu-wrapper">
          <div
            ...
            onClick={(event: any) => {
              document
                .querySelector(".header-nav-burger__nav-wrapper")
                ?.classList.toggle("header-nav-burger__nav-wrapper--active");
              document
      ...
      <nav className="header-nav-burger__nav-wrapper">
        <ul
          className="header-nav-burger__item-wrapper"
          onClick={() => {
            console.log("click");
          }}
        >
          <li
            className={`header-nav-burger__item ${
              location.pathname === "/" ? "header-nav-burger__item--active" : ""
            }`}
            onClick={() => navigate("/")}
          >
            <Link to="/" className="header-nav-burger__link third-title ">
              home
            </Link>
          </li>
          ...
          <li
            className={`header-nav-burger__item ${
              location.pathname === "/phones"
                ? "header-nav-burger__item--active"
                : ""
            }`}
            onClick={() => navigate("/phones")}
          >
            <Link to="/phones" className="header-nav-burger__link third-title ">
              phones
            </Link>
          </li>
          ...
          >
            <Link
              to="/tablets"
              className="header-nav-burger__link third-title "
            >
              tablet
            </Link>
          </li>
          ...
          >
            <div style={{ width: "max-conent", position: "relative" }}>
              ...
              <Link to="/cart" className="header-nav-burger__link third-title ">
                Chart
              </Link>
            </div>
          </li>
        ...
        >
          <div className="search-field-alert__content search-field-alert__content--mobile">
            ...
            >
              <img
                src="/icons/cross.svg"
                className="search-field-alert__cross--icon"
              />
            </div>
            <label
              style={{
