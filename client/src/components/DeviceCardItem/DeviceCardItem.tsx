...
const DeviceCardItem: React.FC<PhoneCardInterface> = ({
  device,
  ...
  useEffect(() => {
    const favorite = favoriteDevices.find(
      (item: favoriteDevice) => item._id === device._id
    );
  ...
  useEffect(() => {
    const favorite = cartDeviceList.find(
      (item: cartDevice) => item._id === device._id
    );
  ...
  return (
    ...
    >
      <div className="phone-card__image--wrapper">
        <img
          src={device.availabelDevices[0].images.main}
          alt={device.title}
          className="phone-card__image--item"
        />
      </div>
      <div className="phone-card__content">
        ...
        <div>
          ...
          <div
            className="phone-card__button--wrapper"
          ...
          >
            ...
            >
              <div onClick={handleAddToCartList}>Add to cart</div>
            </div>
            <div
